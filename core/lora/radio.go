// Package lora provides functionality to determine values for a LoRa radio link,
...
// SpreadingFactors contains data for spreading factors 5-12
...
// SNR calculates the SNR from a spreading factor
